    ...
    <body>
        ...
        <section class="main">
            ...
            <div class="main-skills">
              <div class="counselcard">
                ...
                <button onclick="showSchedule()">Session</button>
              </div>        
            </div>
        ...
        <section class="main">
            ...
            <div class="main-skills">
              <div class="counselcard">
                ...
                <button onclick="showCalendar()">Session</button>
              </div>        
            </div>
        </section>
      ...
      <script>
        ...
        function showSchedule(){
          window.location.href='${pageContext.request.contextPath}/Mentor/schedule.jsp';
        }

        function showCalendar(){
          window.location.href='${pageContext.request.contextPath}/Mentor/Calendar.jsp';
        }
