<span style="font-family: verdana, geneva, sans-serif;"><!DOCTYPE html>
    ...
    <body>
      <div class="container">
        ...
        <section class="main">
            ...
            <div class="main-skills">
              <div class="mscard">
                <!--<img src="img/profileimg.png" alt="" style="width: 100px; height: 100px;"><br><br>-->
                   <h3>Cancelling Scheduled Sessions</h3><br>
      ...
      <script>
        function showcancel()
        {
          window.location.href="${pageContext.request.contextPath}/Admin/cancel.jsp";
        }
      </script>
    </body>
</html>
